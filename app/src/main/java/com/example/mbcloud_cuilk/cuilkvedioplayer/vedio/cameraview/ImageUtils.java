...
/**
 * Created by mbcloud-cuilk on 2018/5/22.
 * 添加文字或水印
 * 博客地址：https://www.jianshu.com/p/a6305270d82f
 */
...
public class ImageUtils {
     ...
     * @return
     */
    public static Bitmap drawTextToCenter2(Context context, Bitmap bitmap, ArrayList<String> strs,
                                          int size, int color) {
        Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
        paint.setColor(color);
        float a= 0f;
