package com.example.mbcloud_cuilk.cuilkvedioplayer.pic.fourthbutton;
...
/**
 * 地址:https://www.jianshu.com/p/eaf122537740
 */
public class SavePhotoSDActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_save_photo_sd);
        initViews();
        initListener();
        init();
    }
    ...
    private void openCamera() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            imageUri = FileProvider.getUriForFile(SavePhotoSDActivity.this, "com.example.mbcloud_cuilk.cuilkvedioplayer.fileprovider", file);//通过FileProvider创建一个content类型的Uri
        } else {
