package com.example.mbcloud_cuilk.cuilkvedioplayer.audio.first;
...
public class AudioTestFirstActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_audio_test_first);
        context = this;
        ...
        mAudioRecoderUtils.setOnAudioStatusUpdateListener(new AudioRecoderUtils.OnAudioStatusUpdateListener() {
            ...
            public void onStop(String filePath) {
                Toast.makeText(AudioTestFirstActivity.this, "录音保存在：" + filePath, Toast.LENGTH_SHORT).show();
