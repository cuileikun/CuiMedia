package com.example.mbcloud_cuilk.cuilkvedioplayer.vedio.originandcustomvediorecoder;
...
import com.example.mbcloud_cuilk.cuilkvedioplayer.vedio.originandcustomvediorecoder.util.MediaController;
 ...
 */
public class MyVideoView extends SurfaceView implements MediaController.MediaPlayerControl, View.OnTouchListener {
...
//                    canSeekForward();
    ...
    public void start() {
        if (mMediaPlayer != null && mIsPrepared) {
            mMediaPlayer.start();
            mmMediaController = new MediaController(getContext());
