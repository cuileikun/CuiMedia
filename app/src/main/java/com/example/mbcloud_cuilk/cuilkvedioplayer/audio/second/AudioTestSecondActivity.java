package com.example.mbcloud_cuilk.cuilkvedioplayer.audio.second;
...
public class AudioTestSecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_audio_test_second);
        //开始录音
